...
class CreateFlightLog extends CreateRecord
{
    ...
    {
        return [
            // 1. Tombol Kustom: Update Lokasi & Cuaca
            ...
            // 2. Tombol Kustom: Start Flight (Stopwatch)
            ...
            // 3. Footer Asli Filament
            $this->getCreateFormAction(),
            // $this->getCreateAnotherFormAction(), // <--- Kita Komen/Hapus baris ini agar hilang
